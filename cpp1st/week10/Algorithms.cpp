...
void Algorithms::AlgorithmSelect() {
    ...
    while (isTestEnd != true) {
        ...
        cout << setw(35) << "12. binary search" << setw(35) << "13. minimum/maximum operations" << endl;
...
void Algorithms::ExampleBinarySearch() {
